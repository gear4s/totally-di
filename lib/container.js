...
Container.prototype.registerSingleton = function (alias, dependency, ctorArgAliases, callback) {
    ...
    try {
        console.log('registering singleton -> alias: ', alias, ', dependency: ', dependency, ', ctor args: ', ctorArgAliases);
...
Container.prototype.registerFactory = function (alias, dependency, factoryMethod, callback) {
    ...
    try {
        ...
        this.__bindings.push({alias: alias, dependency: dependency, factoryMethod: factoryMethod, singleton: false});
        callback();
    } catch (err) {
        callback(err);
    }
...
Container.prototype.registerSingletonFactory = function (alias, dependency, factoryMethod, callback) {

    try {
        console.log('registering singleton factory -> alias: ', alias, ', dependency: ', dependency, ', factory method: ', factoryMethod);
        this.__bindings.push({alias: alias, dependency: dependency, factoryMethod: factoryMethod, singleton: true});
        callback();
    } catch (err) {
        callback(err);
    }
...
Container.prototype.__createInstance = function (binding) {
    ...
    if (factoryMethod != null) {
        var result = dependency[factoryMethod].apply(null);
